//This is State-full Authentication
//Once server restarts all users will log-out, uses extensive memory in backend

import express from "express"
import mongoDBSetUp from "./mongoSetUp.js"
import path from "path"
import cookieParser from 'cookie-parser';
import { authunticateUser } from "./middleware/auth.js"
...
//====== Shorten-Link ======//
app.use("/url", authunticateUser, urlRouter)
app.get("/", authunticateUser, staticRoute)
